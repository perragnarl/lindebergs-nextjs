...
const Header = ({ introduction }: any) => {
	...
	return (
		<header
			className={`relative bg-header after:opacity-10 after:bg-[url('/pattern.png')] after:w-full after:absolute after:h-full after:top-0 after:left-0 py-12 text-center`}
		>
